...
var plantsArr = JSON.parse(fs.readFileSync('./public/vendors/' + vendorLow + 'All.json', 'utf8'));
...
fs.writeFile('./public/' + vendorLow + 'AllFull.json', JSON.stringify(plantsArr, null, 2));
next();
});
